...
(function ($) {
    ...
    WebWorker._workerScriptWrapper = 'var e=null,t=null,n=null;e={{action-data}};t={{event-data}};self._isInitialized=false;n={};self._listeners=n;self._isTerminating=false;self.Action=e;self.Event=t;self.terminateHandler=null;self.isInitialized=function(){return self._isInitialized};self.isTerminating=function(){return self._isTerminating};self._main=function(){var startArgs=arguments;{{main-function}}};self.init=function(){self._isInitialized=true;self.trigger(t.WORKER_LOADED);return self};self.start=function(){if(!self.isInitialized()){return false}self._main.apply(self,arguments);self.trigger(t.WORKER_STARTED);return self};self.on=function(e,t){e+="";t=t||null;if(typeof t!=="function"){return self}if(!(e in n)){n[e]=[]}n[e].push(t);return self};self.one=function(e,t){var n=null;n=function(){t.apply(this,arguments);self.off(e,n);return};self.on(e,n);return};self.off=function(e,t){var r=null;e=e||null;t=t||null;if(e===null&&t===null){for(r in n){delete n[r]}return self}for(r in n){self._removeListenerFromEventType(r,t)}return self};self._removeListenerFromEventType=function(e,t){var r=n[e],i=0;t=t||null;if(t===null){n[e]=[];return self}for(;i<r.length;i++){if(r[i]===t){r.splice(i,1);i--}}return self};self.trigger=function(t,n){var r=null,i=null;i=typeof n!=="undefined";if(typeof t==="string"){r=t||null;if(i){t={type:r,data:n}}}else if(typeof t==="object"){r=t.type||null;n=t.data}if(r===null){return self}self.sendMessage(e.TRIGGER,[t]);return self};self.triggerSelf=function(e,t){var r=this,i=null,s=null,o=null,u=null,a=0;if(typeof e==="string"){i=e||null}else if(typeof e==="object"){i=e.type||null;t=e.data}if(i===null){return r}e.data=t;s=n[i]||null;if(s===null){return r}o=s.length;for(;a<o;a++){u=s[a];u.apply(r,[e])}return r};self.sendMessage=function(e,t){var n=null;e=e||null;t=t||null;if(e===null){return false}n={__isWebWorkerMsg:true};n.action=e;n.args=t;self.postMessage(n);return self};self.terminate=function(n){var r=null,i=null;n=!!n;r=self.terminateHandler||null;if(!self.isTerminating()){self._setTerminatingStatus(true);self.trigger(t.WORKER_TERMINATING)}if(typeof r==="function"){i=r.apply(self,arguments)}self.sendMessage(e.TERMINATE_NOW,[i]);if(n){self._nativeClose()}return self};self.terminateNow=function(){self.terminate(true);return};self._setTerminatingStatus=function(e){self._isTerminating=e;return self};self._nativeClose=self.close;self.close=self.terminate;self.addEventListener("message",function(e){var t=e.originalEvent||e,n=t.data,r=null,i=null;if(typeof n==="object"&&"__isWebWorkerMsg"in n&&n.__isWebWorkerMsg){r=n.action;i=n.args;self[r].apply(self,i);return}return},false);self.init();';
